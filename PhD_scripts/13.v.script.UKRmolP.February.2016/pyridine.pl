...
%model = ( 
  ...
  'model',       #"CAS",             	# options are "SE"    = static-exchange, 
                 ...
                 "SEP",            	#             "CAS"   = complete active space (as a default it is used the model B below), 
  ...
  'nactive',       "15",             	# number of active target orbitals (used for SEP and CAS)
...
%run = (
  ...
  'suffix',          "_prec",  		# string added to model directory to distinguish different runs which have the same model and number of orbitals and states
...
#  'only',           "target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay", #"target-molpro", #   scattering-hamdiag| "target-mpoutrd|target-swedmos|target-swtrmo|target-congen|target-scatci|target-gausprop|target-denprop|scattering-swmol3|scattering-gaustail|scattering-sword|scattering-swedmos|scattering-swtrmo|scattering-congen|scattering-scatci|scattering-hamdiag|scattering-outerres"      # e.g. "scattering-congen|scattering-scatci|scattering-outerres" to run only last part of the scastering calculation
