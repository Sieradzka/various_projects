...
for (my $rrr = 2.4; $rrr <= 2.4; $rrr += 0.1) {
  push(@{$geometry{'geometries'}},
       { 'description', sprintf("%8.5f", $rrr),
         'natype', 20,
         'atoms', [ [ "N", -0.40169472, 0.21353434, 0.00000000 ],
                    [ "C", -1.67659823, 0.13229815, 2.15493942 ],
                    [ "C", -4.29039070, -0.02014953, 2.25665439 ],
                    [ "C", -5.61987043, -0.09510989, 0.00000000 ],
                    [ "H", -0.54748711, 0.18201210, 3.86028870 ],
                    [ "H", -5.24726459, -0.07936121, 4.05988051 ],
                    [ "H", -7.66181301, -0.21306612, 0.00000000 ],
                    [ "C", -1.67659823, 0.13229815, -2.15493942 ],
                    [ "C", -4.29039070, -0.02014953, -2.25665439 ],
                    [ "H", -5.24726459, -0.07936121, -4.05988051 ],
                    [ "H", -0.54748711, 0.18201210, -3.86028870 ],
                    [ "H", 3.19351587, 0.61561286, 0.00000000 ],
                    [ "O", 5.00288195, 0.81644461, 0.00000000 ],
                    [ "H", 5.26709220, 2.58822229, 0.00000000 ],
                    [ "H", 4.75174647, -0.13091355, 3.80079530 ],
                    [ "O", 4.03437491, -0.50023186, 5.40775015 ],
                    [ "H", 4.27845891, -2.26001895, 5.60969694 ],
                    [ "H", 4.75174647, -0.13091355, -3.80079530 ],
                    [ "O", 4.03437491, -0.50023186, -5.40775015 ],
                    [ "H", 4.27845891, -2.26001895, -5.60969694 ] ]
       }
...
%model = ( 
  ...
  # Molecule
  'molecule',     "pyridine_3water",	# Used only for directory and descriptions  

       
  'atoms',        ["N", "C", "C", "C", "H", "H", "H", "C", "C", "H", "H", "H", "O", "H", "H", "O", "H", "H", "O", "H"],    # All atoms must be specified
  'nelectrons',    72,             	# number of target electrons
  ...
  'nfrozen',       "18",            	# number of frozen target orbitals (used for SEP and CAS)      
...
#  'only',            "target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay", # scattering-hamdiag| "target-mpoutrd|target-swedmos|target-swtrmo|target-congen|target-scatci|target-gausprop|target-denprop|scattering-swmol3|scattering-gaustail|scattering-sword|scattering-swedmos|scattering-swtrmo|scattering-congen|scattering-scatci|scattering-hamdiag|scattering-outerres"      # e.g. "scattering-congen|scattering-scatci|scattering-outerres" to run only last part of the scastering calculation
