...
%model = ( 
  ...
  'nfrozen',       "7",   #14 7      	# number of frozen target orbitals (used for SEP and CAS)      
  'nactive',       "19",  #12 19       	# number of active target orbitals (used for SEP and CAS)
  ...
  # Input for MOLPRO 
  'molpro_setting',    "", 
  'ncasscf_states',  {'singlet', [0,0,0,0,0,0,0,0],  	# number of states used to optimalised orbitals in MOLPRO
		      'triplet', [0,0,0,0,0,0,0,0]}, 	# Warning! It works only for 'singlet', 'triplet'.
...
#  'parallel',	     0,  		# 1 for run hamdiag - parallel diagonalization of Hamiltionian matrix
 ...
 # 'only',             "target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay",#"target-congen|target-scatci|target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay", # scattering-hamdiag| "target-mpoutrd|target-swedmos|target-swtrmo|target-congen|target-scatci|target-gausprop|target-denprop|scattering-swmol3|scattering-gaustail|scattering-sword|scattering-swedmos|scattering-swtrmo|scattering-congen|scattering-scatci|scattering-hamdiag|scattering-outerres"      # e.g. "scattering-congen|scattering-scatci|scattering-outerres" to run only last part of the scastering calculation
