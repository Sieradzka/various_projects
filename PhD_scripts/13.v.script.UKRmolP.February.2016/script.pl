...
%personal = (
  ...
  'ad_email_from', '', 		# an e-mail address can be given to send information that calculations ended; 
				# from this e-mail address the message will be send;
  'ad_email_to',   '', 		# the message will be send to this e-mail address.
  'backup_dir',    "",  	# path to back up directory where copies of data will be stored
  'archer_login',  "",  	# the login to archer machine to run there everything except molpro
  'archer_work',   "",  	# the work directory
  'archer_script', "",  	# name of a script to submit on archer; to submit into short queue: "-q short name_of_script"
...
%model = ( 
  ...
  'nactive',       "5",             	# number of active target orbitals (used for SEP and CAS)
...
#  'parallel',	     0,  		# 1 for run hamdiag - parallel diagonalization of Hamiltionian matrix
  ...
  'only',            #"scattering-outerres", #"target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay", # scattering-hamdiag| "target-mpoutrd|target-swedmos|target-swtrmo|target-congen|target-scatci|target-gausprop|target-denprop|scattering-swmol3|scattering-gaustail|scattering-sword|scattering-swedmos|scattering-swtrmo|scattering-congen|scattering-scatci|scattering-hamdiag|scattering-outerres"      # e.g. "scattering-congen|scattering-scatci|scattering-outerres" to run only last part of the scastering calculation
...
%dirs = (
  ...
  'integrals', "", 
  'molpro',    "",
  'basis',     "SCRIPT/basis.sets",     # Directory where basis sets are - templates named 'swmol3.A.$basis' 
					# or 'molpro.A.$basis' where 'A' stands for an atom
  'templates', "SCRIPT/input.templates",# Directory where input templates are - read if 'use_templates' = 1
