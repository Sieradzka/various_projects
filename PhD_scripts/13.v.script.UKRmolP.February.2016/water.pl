...
#                    [ "H", 1.600953499,     0.451633012, 0.00000000 ]] # water
         'atoms', [ [ "O", 0.0,                      0.0,                      0.1157 ],
                    [ "H", 0.0,                      0.7488,                  -0.4628 ],
                    [ "H", 0.0, 		    -0.7488, 		      -0.4628] ]
#         'atoms', [ [ "H", -0.1959732709,       -0.8653664893,        0.0000000000 ],
#                    [ "O", -0.0814018542,        0.0782965741,        0.0000000000 ],
#                    [ "H",  0.8471881043,        0.2389938968,        0.0000000000] ]
       }
  );
}
...
%model = ( 
  ...
  'nfrozen',       "2",            	# number of frozen target orbitals (used for SEP and CAS)      
  'nactive',       "3",             	# number of active target orbitals (used for SEP and CAS)
  'nvirtual',      "16",             	# number of virtual states
...
%run = (
  ...
  'precision',       "double", 		# "double" or "quadru" - option whether run executables with double or quadruple precision
...
#  'only',             "target-denprop|scattering-congen|scattering-scatci|scattering-outerres|scattering-time-delay", # "target-radden", # scattering-hamdiag| "target-mpoutrd|target-swedmos|target-swtrmo|target-congen|target-scatci|target-gausprop|target-denprop|scattering-swmol3|scattering-gaustail|scattering-sword|scattering-swedmos|scattering-swtrmo|scattering-congen|scattering-scatci|scattering-hamdiag|scattering-outerres"      # e.g. "scattering-congen|scattering-scatci|scattering-outerres" to run only last part of the scastering calculation
